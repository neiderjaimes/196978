...
function optionsframework_options() {
	...
	$imagepath =  get_bloginfo('stylesheet_directory') . '/includes/images/';
	...
	$options[] = array( "name" => "Logo and Banner",
						"type" => "heading");
	...
	$options[] = array( "name" => "Logo URL",
						"desc" => "Enter the direct path to your logo image. For example http://your_website_url_here/wp-content/themes/theme1421/images/logo.png",
						"id" => "logo_url",
						"type" => "upload");
	
	$options[] = array( "name" => "Banner Path",
						"desc" => "Enter the direct path to your banner image. For example http://your_website_url_here/wp-content/themes/theme1421/images/banner.png",
						"id" => "banner_url",
						"type" => "upload");
	
	$options[] = array( "name" => "Banner Link",
						"desc" => "Enter the link for banner.",
						"id" => "banner_link",
						"std" => "#",
						"class" => "tiny",
						"type" => "text");
	...
	$options[] = array( "name" => "Footer copyright text",
						"desc" => "Enter text used in the right side of the footer.",
						"id" => "footer_text",
						"std" => "",
						"type" => "text");
