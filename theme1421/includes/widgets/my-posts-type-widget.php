...
function widget($args, $instance) {
  ...
  $cat_posts = new WP_Query(
	...
	echo "<ul class='post_list clearfix'>\n";
	}else{
    echo "<ul class='post_list clearfix " .$instance['container_class'] ."'>\n";
    }
	...
	?>
		<li class="cat_post_item-<?php echo $posts_counter; ?> clearfix">
            ...
            <?php if ( $instance['show_title'] ) : ?>
			  <?php echo $instance["before_post_title"]; ?><h5><a class="post-title" href="<?php the_permalink(); ?>" rel="bookmark" title="<?php the_title_attribute(); ?>"><?php if ( $instance['show_title_date'] ) {?>[<?php the_time('m-d-Y'); ?>]<?php }else{?><?php the_title(); ?><?php }?></a></h5><?php echo $instance["after_post_title"]; ?>
			<?php endif; ?>
            <div>
	...
	<?php } ?>
	<?php echo "</ul><div class='clear'></div>\n"; ?>
	<?php if ( $instance['global_link'] ) : ?>
	  <a href="<?php echo $instance['global_link_href']; ?>" class="more-alt"><?php if($instance['global_link_text']==""){ ?>View all<?php }else{ ?><?php echo $instance['global_link_text']; ?><?php } ?></a>
	<?php endif; ?>
