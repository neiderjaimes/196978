...
function shortcode_recent_posts($atts, $content = null) {
        ...
        endforeach;
				...
				$output .= '<span class="cat-wrap">'.$name.'</span>';
...
function shortcode_audio($atts, $content = null) {
    ...
    if($mp3 !== false){
        ...
        _e("The URL you entered is not a .mp3 file.", "theme1421");
...
function shortcode_video($atts, $content = null) {
    ...
    if($vimeo !== false){
        ...
        _e("You entered a video URL that isn't compatible with this shortcode.", "theme1421");
